<template>
  <div ref="pageRef" class="window-table-page">
    <UiLoader v-if="loading" theme="page" loading />
    <div class="window-table-page__content">
      <Table
      ...
      <div class="window-table-page__pagination">
    ...
    <div class="window-table-page__actions"></div>
  </div>
</template>
